...
That unfiltered input may contain unintended command calls, which can give the user access to sensitive information or to run destructive commands on your server.
